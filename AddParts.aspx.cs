...
public partial class Addh : System.Web.UI.Page
{
    String image, path;
    ...
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("Insert into Parts values('" + Txtprodid.Text + "','" + txtprodname.Text + "','" + Image1.ImageUrl + "','" + RemoveSpecialCharacters(txtsdesc.Text) + "'," + txtprice.Text + ")", con);
        cmd.ExecuteNonQuery();
        con.Close();
